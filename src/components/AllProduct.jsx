...
const AllProduct = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const productCollection = collection(db, "productos"); // Asegúrate de que el nombre de la colección es correcto
  ...
  return (
    <div className="min-h-screen w-[80%] m-auto">
      <div className="grid grid-cols-4 gap-x-2 gap-y-6 my-6">
