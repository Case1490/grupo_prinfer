...
import ProductRelatedRecomends from "./ProductRelatedRecomends";

const ProductRecomends = () => {
  ...
  useEffect(() => {
    const fetchProductById = async () => {
      ...
      const productDoc = productSnapshot.docs.find((doc) => doc.id === id);
    ...
    <div className="bg-gray-100 min-h-screen pt-[240px] lg:pt-[140px]">
      ...
      <div className=" bg-white py-4 rounded-lg shadow-xl mt-10 mb-4">
        ...
        <div className="w-[80%] m-auto mt-8">
          <ProductRelatedRecomends productId={product.id} />
        </div>
      </div>
    </div>
  );
...
export default ProductRecomends;
